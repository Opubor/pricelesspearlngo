...
function FuelTheVision() {
  return (
    <div className="py-24 bg-[linear-gradient(to_right_bottom,rgba(128,0,0,0.5),rgba(128,0,0,0.5)),url('/pic3.jpg')] bg-center bg-cover bg-fixed flex flex-col justify-center items-center">
      <h1
        data-aos="fade-up"
        className="text-white text-3xl lg:text-5xl font-extrabold text-center"
      >
        Fuel the Vision
      </h1>
      ...
      <p
        data-aos="fade-up"
        className="text-xs lg:text-sm text-white text-center pt-4"
      >
      ...
      <div className="flex gap-2 mt-8">
        <Link
          ...
          target="blank"
          className="flex justify-center items-center gap-1 rounded-full px-5 lg:px-16 py-2 lg:py-4 text-xs bg-white text-wine hover:bg-rose-950 hover:text-white"
        >
